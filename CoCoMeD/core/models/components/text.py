...
def get_text_feature_extractor(config, vocab_words):
    word_embedding_size = config['word_embedding_size']#300
    num_layers_LSTM = config['num_layers_LSTM']#1
...
class LSTMEncoder(nn.Module):
    ...
    def __init__(self, word_embedding_size, num_layers_LSTM, lstm_features, vocab_words):
        ...
        self.word_embedding_size = word_embedding_size#字符编码
        self.num_layers_LSTM = num_layers_LSTM#LSTM层数
        self.lstm_features = lstm_features#隐藏层维度
